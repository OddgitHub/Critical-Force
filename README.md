...
* [Application for Macs with Intel chips](https://github.com/OddgitHub/Critical-Force/releases/download/v1.2.0/CriticalForce.app.zip) (unzip and allow app start)
